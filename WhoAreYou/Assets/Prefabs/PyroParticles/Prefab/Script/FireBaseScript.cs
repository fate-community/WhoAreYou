...
namespace DigitalRuby.PyroParticles
{
    ...
    public class FireBaseScript : MonoBehaviour
    {
        ...
        protected virtual void Awake()
        {
            ...
            int monsterLayer = UnityEngine.LayerMask.NameToLayer("Monster");
            UnityEngine.Physics.IgnoreLayerCollision(fireLayer, monsterLayer);
            int FloorLayer = UnityEngine.LayerMask.NameToLayer("Floor");
            UnityEngine.Physics.IgnoreLayerCollision(fireLayer, FloorLayer);
        }
